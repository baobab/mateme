...
DateSelector.prototype = {
    ...
    incrementYear: function() {
        ...
        if(this.currentYear.value < (new Date().getFullYear())) this.currentYear.value++;
    ...
    decrementDay: function() {
        if (this.currentDay.value > 1)
            ...
            this.currentDay.value = this.currentDay.value; //DateUtil.getLastDate(this.date.getFullYear(), this.date.getMonth()).getDate();
