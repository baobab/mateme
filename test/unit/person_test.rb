...
class PersonTest < Test::Unit::TestCase
  ...
  describe "Person" do
    ...
    it "should return the age and increase it by one if the birthdate was estimated and you are checking during the year it was created" do 
      person = Person.make(:birthdate => "2000-07-01".to_date, :birthdate_estimated => true)
    ...
    it "should format the birthdate" do
      ...
      person = Person.make(:birthdate => "2000-07-01".to_date, :birthdate_estimated => true).birthdate_formatted.should == "??/???/2000"
      person = Person.make(:birthdate => "2000-06-15".to_date, :birthdate_estimated => true).birthdate_formatted.should == "??/Jun/2000"
      person = Person.make(:birthdate => "2000-07-01".to_date, :birthdate_estimated => false).birthdate_formatted.should == "01/Jul/2000"     
    end
