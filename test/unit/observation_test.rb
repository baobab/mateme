...
class ObservationTest < ActiveSupport::TestCase
  ...
  context "Observations" do
    ...
    should "allow you to assign the value coded or text" do
      observation = Observation.new(:concept_id => concept(:outpatient_diagnosis).id, :value_coded => nil, :value_text => nil)
    ...
    should "find the most common active observation and sort by the answer" do
      observation = Observation.new(:concept_id => concept(:outpatient_diagnosis).id, :value_text => nil, :value_coded => concept_name(:extrapulmonary_tuberculosis_without_lymphadenopathy).concept_id, :value_datetime => nil)
      observation = Observation.new(:concept_id => concept(:outpatient_diagnosis).id, :value_text => nil, :value_coded => concept_name(:immune_reconstitution_inflammatory_syndrome_construct).concept_id, :value_datetime => nil)
      observation = Observation.new(:concept_id => concept(:outpatient_diagnosis).id, :value_text => nil, :value_coded => concept_name(:immune_reconstitution_inflammatory_syndrome_construct).concept_id, :value_datetime => nil)
    ...
    should "be displayable as a string" do
      observation = Observation.new(:concept_id => concept(:outpatient_diagnosis).id, :value_coded => concept(:alcohol_counseling).id, :value_coded_name_id => concept_name(:alcohol_counseling).id, :value_numeric => 1, :value_datetime => nil)
