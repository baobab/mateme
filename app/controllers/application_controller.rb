class ApplicationController < ActionController::Base
  ...
  before_filter :login_required, :except => ['login', 'logout','demographics', 'add_update_property','retrieve_visit_treatments','retrieve_visit_diagnoses','retrieve_influenza_info','remote_chronic_conditions']
  before_filter :location_required, :except => ['login', 'logout', 'location','demographics', 'add_update_property','retrieve_visit_treatments','retrieve_visit_diagnoses','retrieve_influenza_info','remote_chronic_conditions']
