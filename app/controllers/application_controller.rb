class ApplicationController < ActionController::Base
  ...
  before_filter :login_required, :except => ['login', 'logout','demographics', 'add_update_property',
    'observations_printable', 'cohort_print', 'print_cohort', 'report', 'diagnoses_report']
  before_filter :location_required, :except => ['login', 'logout', 'location','demographics',
    'add_update_property', 'observations_printable', 'cohort_print', 'print_cohort', 'report', 'diagnoses_report']
