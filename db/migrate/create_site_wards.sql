...
INSERT INTO location (name, creator, date_created, retired) VALUES ("Ante-Natal Ward", 1, now(), 0), ("Bwaila Maternity Unit", 1, now(), 0), ("Labour Ward", 1, now(), 0), ("Post-Natal Ward", 1, now(), 0), ("Gynaecology Ward", 1, now(), 0), ("Post-Natal Ward (Low Risk)", 1, now(), 0), ("Post-Natal Ward (High Risk)", 1, now(), 0), ("Kamuzu Central Hospital", 1, now(), 0); 
